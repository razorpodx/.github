...
<div style="style="display:inline-block; padding:0px 0px 15px 0px;" align="center">
    ...
    <a href="https://github.com/razorpodx" target="_blank"><center><img style="height:45%; width:80%; cursor: pointer; margin-top:15px;" src="https://skillicons.dev/icons?i=nuxt,postgres,strapi"></a>
</div>
